...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py7zr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13346&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py7zr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py7zr` can be installed with:

```
conda install py7zr
```

It is possible to list all of the versions of `py7zr` available on your platform with:
